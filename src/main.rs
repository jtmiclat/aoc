...
fn main() {
    ...
    match (year, day, part) {
        ...
        (2015, 6, 2) => year_2015::day6::part2(file),
        (2015, 7, 1) => year_2015::day7::part1(file),
        (2015, 7, 2) => year_2015::day7::part2(file),
        (2015, 8, 1) => year_2015::day8::part1(file),
        (2015, 8, 2) => year_2015::day8::part2(file),
